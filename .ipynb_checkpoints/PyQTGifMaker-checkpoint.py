...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.fps_list = ['1', '10', '12', '15', '24', '25', '30', '50', '60', '72', '90' '100', '120', '144', '240', '300']
        self.fps_select.addItems(self.fps_list)
        ...
        self.file_label = QLabel("File: " + self.file_path)
        self.fps_label = QLabel("Select FPS (selecting higher than original video doesn't really work)")
        ...
        layout.addWidget(self.fps_select)
    ...
    def file_browse(self):
        ...
        self.file_label.setText("File: " + self.file_path)
        print(self.fps_select.currentText())
    ...
    def make_gif(self):
        ...
        #FPS select
        fps = self.fps_select.currentText()
        ...
        m_cmd = 'ffmpeg -i %s.mp4 -i pyqtgifpalettetemp.png -filter_complex "[0:v] fps=%s,scale=%s:-1 [new];[new][1:v] paletteuse" %s.gif -y' % (output_name, fps, resolution, output_name)
